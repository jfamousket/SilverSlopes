...
var ajax_anim = {
    ...
    response:function(msg){
        $(this.name).children('.centered').html('<section id="hire_ajax" class="centered_box"><div class="row"><div class="hb-modal-head col-sm-12"><h3 align="center" class="kaushan-lg" style="color:#f50044;">Silverslopes</h3><hr></div><div class="col-sm-4"><h2 style="color:#f50044;">DEMANDE SOUMISE!</h2></div>'+
            '<div class="col-sm-8">'+
            '<h4>'+msg+'</h4>'+
          '</div><div class="hb-modal-foot col-sm-12"><div class="clearfix"><button onclick="closeBtn()" class="float-right"><span class="lnr lnr-checkmark-circle"></span> Ferme</button></div></div></div></section>');
    },
    failed:function(){
